...
import com.lyx.ganon.admin.model.SysUserExample.Criteria;
import com.lyx.ganon.admin.model.SysUserExample.Criterion;
...
public class SysUserSqlProvider {
    ...
    public String insertSelective(SysUser record) {
        ...
        if (record.getPasswordMd5() != null) {
            sql.VALUES("password_md5", "#{passwordMd5,jdbcType=VARCHAR}");
        }
        
        if (record.getPasswordSha() != null) {
            sql.VALUES("password_sha", "#{passwordSha,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(SysUserExample example) {
        ...
        sql.SELECT("name");
        sql.SELECT("password");
        sql.SELECT("password_md5");
        sql.SELECT("password_sha");
        sql.FROM("sys_user");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPasswordMd5() != null) {
            sql.SET("password_md5 = #{record.passwordMd5,jdbcType=VARCHAR}");
        }
        
        if (record.getPasswordSha() != null) {
            sql.SET("password_sha = #{record.passwordSha,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(SysUser record) {
        ...
        if (record.getPasswordMd5() != null) {
            sql.SET("password_md5 = #{passwordMd5,jdbcType=VARCHAR}");
        }
        
        if (record.getPasswordSha() != null) {
            sql.SET("password_sha = #{passwordSha,jdbcType=VARCHAR}");
        }
